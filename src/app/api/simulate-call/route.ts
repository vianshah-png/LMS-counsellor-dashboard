...
4. How does you program comapre in front of you compititors...
...
14."What if I don't lose weight?" → BN has a structured medical approach. If you follow the plan, results are guaranteed. We monitor progress every session.
`;

const CLIENT_PERSONA = `You are a SKEPTICAL, PRICE-CONSCIOUS potential client who needs convincing.
